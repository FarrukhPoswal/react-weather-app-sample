// Saints of the Days of the Year...
const ephemeris = [
    [
        ["Le Jour de l'An", ""],
        ["Basile", "Saint"],
...
// Create a function to determine the name of the saint of the current day
const getSaintsOfDay = (month, day) => {
    const saintOfDay = ephemeris[month][day - 1];
    return `${saintOfDay[1]} ${saintOfDay[0]}`;
};

// Export
export default getSaintsOfDay;
